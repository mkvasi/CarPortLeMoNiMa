...
-- -----------------------------------------------------
-- Table `fog`.`MATERIALS_TYPE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fog`.`MATERIALS_TYPE` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `fog`.`MATERIALS_MEASURE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fog`.`MATERIALS_MEASURE` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- Table `fog`.`REQUEST`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fog`.`REQUEST` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `fog`.`REQUEST_HAS_BILLOFMATERIAL`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fog`.`REQUEST_HAS_BILLOFMATERIAL` (
...
-- -----------------------------------------------------
-- Table `fog`.`CARPORT_HAS_MATERIALS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fog`.`CARPORT_HAS_MATERIALS` (
  `carport_id` INT(11) NOT NULL,
